...
$(function () {
    ...
    function n() {
        ...
        if ($(".J_menuTab").each(function () {
            ...
            var s = '<a href="javascript:;" class="active J_menuTab" data-id="' + id + '">' + i + ' <i class="fa fa-times-circle"></i></a>';
            $(".J_menuTab").removeClass("active");
            var r = '<iframe class="J_iframe" name="iframe' + a + '" width="100%" height="100%" src="' + t + '?v=4.0" frameborder="0" data-id="' + id + '" seamless></iframe>';
